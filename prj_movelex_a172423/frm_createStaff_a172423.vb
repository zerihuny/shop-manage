Public Class frm_createStaff_a172423
    ...
    Private Sub btn_create_Click(sender As Object, e As EventArgs) Handles btn_create.Click
        ...
        If checkInput = True Then
            Try
                Dim mysql As String = "INSERT INTO TBL_STAFF_A172423 VALUES ('" & "STAFF" + txt_id.Text & "','" & txt_name.Text & "','" & gender & "','" & today & "','" & today & "' )"
            ...
            Catch ex As Exception
                Dim reopen As New frm_createStaff_a172423
                Me.Close()
                reopen.Show()
