Public Class frm_make_order_a172423
    Private Sub frm_make_order_a172423_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'all table
        Dim mysql1 As String = "SELECT * FROM TBL_CUSTOMER_A172423"
        Dim mysql2 As String = "SELECT * FROM TBL_STAFF_A172423"
        Dim mysql3 As String = "SELECT * FROM TBL_PRODUCT_A172423"
    ...
    Private Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        Dim mysql As String = "SELECT * FROM TBL_PRODUCT_A172423 WHERE FLD_PRODUCT_NAME='" & cmb_product.Text & "'"
        ...
        ElseIf IsNumeric(txt_quantity.Text) = True Then
            If txt_quantity.Text > table.Rows(0).Item("FLD_PRODUCT_QUANTITY") Then
                check = False
    ...
    Private Sub btn_make_Click(sender As Object, e As EventArgs) Handles btn_make.Click
        ...
        'All specific data
        Dim customer As String = "SELECT * FROM TBL_CUSTOMER_A172423 WHERE FLD_CUSTOMER_NAME='" & cmb_customer.Text & "'"
        Dim staff As String = "SELECT * FROM TBL_STAFF_A172423 WHERE FLD_STAFF_NAME='" & cmb_staff.Text & "'"
        ...
        'create order
        Try
            Dim order As String = "INSERT INTO TBL_ORDERS_A172423 VALUES ('" & order_id & "','" & tbl_customer.Rows(0).Item("FLD_CUSTOMER_ID") & "','" & tbl_staff.Rows(0).Item("FLD_STAFF_ID") & "','" & txt_total.Text & "','" & today & "','" & today & "')"
        ...
        For i As Integer = 0 To (row - 1)
            Try
                ...
                'create item
                Dim item As String = "INSERT INTO TBL_ITEM_A172423 VALUES ('" & item_id & "','" & order_id & "','" & dg_cart.Rows(i).Cells(0).Value & "','" & dg_cart.Rows(i).Cells(3).Value & "','" & today & "','" & today & "')"
